...
<head>
    ...
    <!-- TITLE OF SITE -->
    <title>Oumezzine Farah Portfolio</title>

    <!-- favicon -->
    <link id="favicon" rel="icon" type="image/png" href="{{asset('images/Me.ico')}}">
    <!-- icons -->
    ...
    <div class="intro">
                    ...
                    <div class="display-table">
                        <div class="display-table-cell">
                            ...
                            <div id="typed-strings">
                                <span>Oumezzine Farah</span>
                                <span>a student in <br> computer engineering</span>
                                <span>FROM TN</span>
                            </div>
                            ...
                            <div class="more_info">
                                ...
                                <div class="item">
                                    ...
                                    <span class="info-body">12-06-2000</span>
                                </div>

                                <div class="item">
                                    <span class="info-title">Address : </span>
                                    <span class="info-body">Monastir</span>
                                </div>

                                <div class="item">
                                    <span class="info-title">E-mail : </span>
                                    <span class="info-body">oumezzinefarah@outlook.com</span>
                                    <br>
                                    <span class="info-body">farah.omezzine@esprim.tn</span>
                                    <br>
                                </div>

                                <div class="item">
                                    <span class="info-title">Phone : </span>
                                    <span class="info-body">99 029 943</span>
                                </div>
        ...
        <div class="mob-menu">
            <div class="mob-menu-content">
                <div class="float-left">
                    <p class="menu-title">Oumezzine Farah</p>
                </div>
        ...
        <div class="side side-right">
            <div class="intro-content">
                <div class="profile">
                    <img src="{{asset('images/me.jpeg')}}" alt="profile">
                </div>
                <h1>
                    <span>Oumezzine Farah</span>
                </h1>
                <div class="menu">
                    ...
                    <div class="social-icons">
                        ...
                        <a href="https://medium.com/@OumezzineFarah">
                            <i class="fa fa-medium"></i>
                        </a>
                        <a href="https://github.com/farahoumezzine">
    ...
    <div class="page page-right full-height">
        <div id="pt-main" class="pt-perspective page-inner">
            ...
            <section class="about padding-bottom-90 pt-page pt-page-current" id="about">
                <div class="content">
                    <img class="center-block" src="assets/images/me-1.jpg" alt="">
                    <div class="container">
                        <div class="more-about-me">
                            <p class="margin-top-30">Currently pursuing further studies in computer engineering at Esprit.
                                My academic and professional journey in software engineering is underpinned by extensive practical experience, including over 18 diverse projects using a variety of programming languages and tools.
                            </p>
                            <p class="margin-bottom-0">My engagement in multiple hackathons has not only honed my technical skills but also strengthened my abilities in teamwork and creative problem-solving under pressure</p>
                            <br>
                            <p> Additionally, I am a prolific writer regularly publishing articles on Medium and my personal blog.
                                Each piece not only discusses current trends and insights but also offers added value
                                to my readers such as recommended books or practical examples
                            </p>
                        ...
                        <div class="skills row margin-top-45">
                            <div class="col-sm-6 item">
                                <h3 class="subtitle">My Professional Skills
                                ...
                                <!-- Skill 1 -->
                                <div class="skill">
                                    <h5 class="name">HTML5/CSS3, Javascript</h5>
                                    <div>
                                ...
                                <!-- Skill 3 -->
                                <div class="skill">
                                    <h5 class="name">Bootstrap, jQuery</h5>
                                    <div>
                                        <span class="true"></span>
                                        <span class="true"></span>
                                        <span class="true"></span>
                                ...
                                <!-- Skill 3-1 -->
                                <div class="skill">
                                    <h5 class="name">ADOBE AFTER EFFECTS</h5>
                                    <div>
                                        <span class="true"></span>
                                        <span class="true"></span>
                                        <span class="true"></span>
                            ...
                            <div class="col-sm-6 item mob-margin-top-45">
                                ...
                                <!-- Skill 5 -->
                                <div class="skill">
                                    <h5 class="name">Android, React Native</h5>
                                    <div>
                                        <span class="true"></span>
                                        <span class="true"></span>
                                        <span class="true"></span>
                                ...
                                <!-- Skill 6 -->
                                <div class="skill">
                                    <h5 class="name">MySQL, PHPMyAdmin</h5>
                                    <div>
                                        <span class="true"></span>
                                        <span class="true"></span>
                                        <span class="true"></span>
                                ...
                                <!-- Skill 7-1 -->
                                <div class="skill">
                                    <h5 class="name">Adobe Photoshop </h5>
                                    <div>
                                        <span class="true"></span>
                                        <span class="true"></span>
                                        <span class="true"></span>
                        ...
                        <div class="skills row margin-top-45">
                            <div class="col-sm-6 item">
                                <h3 class="subtitle">My Personal Skills
                                    <svg width="66px" height="8px" viewBox="0 0 66 8" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                        <g class="Web" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(-147.000000, -464.000000)" opacity="0.2" stroke-linecap="round" stroke-linejoin="round">
                                            <g class="Header" stroke="#FFFFFF" stroke-width="3">
                                                <path d="M149,466 C152.87377,466 152.87377,470 156.747541,470 C160.621311,470 160.621311,466 164.493293,466 C168.367064,466 168.367064,470 172.240834,470 C176.112816,470 176.112816,466 179.984798,466 C183.858569,466 183.858569,470 187.730551,470 C191.607898,470 191.607898,466 195.483457,466 C199.362593,466 199.362593,470 203.241728,470 C207.120864,470 207.120864,466 211,466"></path>
                        ...
                        <div class="testimonials margin-top-45">
                            ...
                            <div class="owl">
                                ...
                                <div class="testimonial">
                                    ...
                                    <img src="assets/images/testimonials/client_1.jpg" alt="">
                                    <h4>John Doe</h4>
                                    <h5>Client</h5>
                                </div>
                                ...
                                <div class="testimonial">
                                    ...
                                    <img src="assets/images/testimonials/client_2.jpg" alt="">
                                    <h4>John Doe</h4>
                                    <h5>Client</h5>
                                </div>
                                ...
                                <div class="testimonial">
                                    ...
                                    <img src="assets/images/testimonials/client_3.jpg" alt="">
                                    <h4>John Doe</h4>
                                    <h5>Client</h5>
                                </div>
                                ...
                                <div class="testimonial">
                                    ...
                                    <img src="assets/images/testimonials/client_4.jpg" alt="">
                                    <h4>John Doe</h4>
                                    <h5>Client</h5>
                                </div>
                        ...
                        <div class="fun-facts margin-top-45">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-xs-6 mob-margin-top-30">
                                    <div class="item">
           ...
           End Services Section-->
            ...
            <section class="portfolio_sec padding-bottom-90 pt-page" id="portfolio">
                <div class="content">
                    <div class="container">
                        <div class="sec_title">
                            <h2>Portfolio</h2>
                                    ...
                                    <div class="display-table-cell">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <img src="assets/images/portfolio/work-5.jpg" alt="" class="margin-top-45">
            ...
            <!--Start Blog Section-->
            <section class="blog padding-bottom-90 pt-page" id="blog">
                <div class="content">
                    <div class="container">
                        <div class="sec_title">
                            <h2>My Blog</h2>
...
<script src="{{asset('js/nasa-particles.js')}}"></script>
